...
* [ship](https://github.com/paralect/ship) ⭐ 435 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-05 - A toolkit for makers to ship better products faster 🚀
...
* [mantinedev/vite-template](https://github.com/mantinedev/vite-template) ⭐ 235 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-20 - Mantine + Vite template
* [mantinedev/remix-template](https://github.com/mantinedev/remix-template) ⚠️ Archived - Remix + Mantine template
* [gfazioli/next-app-nextra-template](https://github.com/gfazioli/next-app-nextra-template) ⭐ 36 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 - Mantine + Next.js app router + Nextra 4 template (7.0+) + [Live Demo](https://next-app-nextra-template.vercel.app/)
...
* [gfazioli/next-app-fumadocs-template](https://github.com/gfazioli/next-app-fumadocs-template) ⭐ 4 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-14 - Next.js App Router + Mantine + Fumadocs (headless) template — 100% Mantine UI, no Tailwind
...
* [UptimeFlare](https://github.com/lyc8503/UptimeFlare) ⭐ 3,830 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - Free and serverless uptime monitoring / status page on Cloudflare Workers, with Geo-specific checks
* [ryot](https://github.com/ignisda/ryot) ⭐ 3,606 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-24 - A self hosted platform for tracking various facets of your life - media, fitness etc
...
* [react-data-fetching](https://github.com/KevinVandy/react-data-fetching) ⭐ 553 | 🐛 1 | 🌐 TypeScript | 📅 2025-09-30 - A repository to showcase different ways to fetch data in React.
