...
* [gfazioli/next-app-nextra-template](https://github.com/gfazioli/next-app-nextra-template) ⭐ 36 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - Mantine + Next.js app router + Nextra 4 template (7.0+) + [Live Demo](https://next-app-nextra-template.vercel.app/)
...
* [UptimeFlare](https://github.com/lyc8503/UptimeFlare) ⭐ 3,821 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - Free and serverless uptime monitoring / status page on Cloudflare Workers, with Geo-specific checks
* [ryot](https://github.com/ignisda/ryot) ⭐ 3,602 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-20 - A self hosted platform for tracking various facets of your life - media, fitness etc
